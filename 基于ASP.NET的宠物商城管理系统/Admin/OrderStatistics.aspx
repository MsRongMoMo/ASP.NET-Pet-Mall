<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderStatistics.aspx.cs" Inherits="AdminManger_OrderStatistics" %>
...
<tr>
 <td height="26" >
  ...
  <td align="center" style="height: 22px">
      ...
      <tr>
          <td align="center" style="height: 22px">
              商品名称：<asp:TextBox ID="SearchShangPinName" runat="server"></asp:TextBox>
              开始时间：<input id="txttime" runat="server" onclick="fPopCalendar(event,this,this)" onfocus="this.select()"
                  readonly="readonly" size="15" style="border-right: #cccccc 1px solid; border-top: #cccccc 1px solid;
                  border-left: #cccccc 1px solid; border-bottom: #cccccc 1px solid" type="text" />
              结束时间：<input id="Text1" runat="server" onclick="fPopCalendar(event,this,this)" onfocus="this.select()"
                      readonly="readonly" size="15" style="border-right: #cccccc 1px solid; border-top: #cccccc 1px solid;
                      border-left: #cccccc 1px solid; border-bottom: #cccccc 1px solid" type="text" />
            ...
            <tr align="right" bgcolor="#eef4ea">
                <td align="left" colspan="10" height="36">
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        BackColor="White" CellPadding="5" DataKeyNames="OrderID" OnPageIndexChanging="gvInfo_PageIndexChanging"
                        OnRowDataBound="gvInfo_RowDataBound"   PageSize="10" ShowFooter="True"
                        Width="100%">
                        ...
                        <RowStyle HorizontalAlign="Left" />
                          <Columns>
                              <asp:TemplateField HeaderText="商品名称">
                                  <ItemTemplate>
                                      <asp:Image ImageUrl='<%#Eval("ShangPinPhoto","../files/{0}")%>' runat="server" Width="50px"/>
                                      
                                      <asp:Label Text='<%#Eval("ShangPinName")%>' runat="server" ID="ShangPinName"/>
                                  </ItemTemplate>
                              </asp:TemplateField> 
                           
                          <asp:BoundField DataField="dingdanshijian" HeaderText="下单时间" />
                               <asp:BoundField DataField="ShangPinPrice" HeaderText="单价" />
                                  <asp:BoundField DataField="shuliang" HeaderText="销售数量" />
                              <asp:TemplateField HeaderText="总金额">
                                  <ItemTemplate>
                                      <asp:Label Text='<%#Eval("dingdantotal")%>' runat="server" ID="dingdantotal"/>
                                  </ItemTemplate>
                              </asp:TemplateField>  
                         
                              <asp:TemplateField HeaderText="会员折后价">
                                  <ItemTemplate>
                                      <asp:Label Text='<%#Eval("memberPrice")%>' runat="server" ID="memberPrice"/>
                                  </ItemTemplate>
                              </asp:TemplateField>  
