<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShangPinTypeManger.aspx.cs" Inherits="Admin_ShangPinTypeManger" %>
                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "XiuGaiShangPinLeiBie.aspx?id="+Eval("id") %>'
