                    ...
                    <asp:GridView ID="gvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="用户密码">
                                <ItemTemplate>
                                    <asp:Label ID="pwd" runat="server" Text='<%# Bind("pwd") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="年龄" SortExpression="Age">
                                <ItemTemplate>
                                    <asp:Label ID="Age" runat="server" Text='<%# Bind("Age") %>' Width="130px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="30px" />
                            </asp:TemplateField>
                            
                            <asp:TemplateField HeaderText="卡余额" SortExpression="Age">
                                <ItemTemplate>
                                    <asp:Label ID="Age" runat="server" Text='<%# Bind("MemberMoney") %>' Width="130px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="30px" />
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="总充值">
                                <ItemTemplate>
                                    <asp:Label ID="pwd" runat="server" Text='<%# Bind("ZongMoney") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="会员折扣">
                                <ItemTemplate>
                                    <asp:Label ID="emal" runat="server" Text='<%# Bind("ZheKou") %>' Width="83px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="100px" />
                            </asp:TemplateField>
