    ...
    <div class="shangPinTypeList clearfix layout_shangPinTypeList">
        <asp:DataList ID="DataList1" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" Width="920px" Height="406px" HorizontalAlign="Left" OnItemCommand="DataList1_ItemCommand">
             <ItemTemplate>  
                 ...
                 <img alt="" border="0" src='files/<%#Eval("ShangPinPhoto")%>' style="width: 210px; height: 210px" /></a>
                 ...
                 <asp:LinkButton runat="server"  ID="addToCart" Text="加入购物车"  CssClass="addToCart" CommandArgument='<%# Eval("ShangPinID") %>' CommandName="addToCart" OnClientClick="return alert('加入购物车成功！')"/>
       </div>                                       
        </ItemTemplate>
       </asp:DataList>
      </div>
