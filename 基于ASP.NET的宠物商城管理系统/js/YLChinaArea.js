 ...
 * 此为自由拷贝版本，您可以在此基础上添加任何功�?
 * 彦磊建议您将修改过的版本或发布地址发到彦磊博客上以共享，也建议您保留部分彦磊的信息
 * 
 * 
 * 使用前您一定要引入jQurey及压缩包中的两个脚本文件,�?
 ...
 *  </div>
 * 在ASP.NET中，您需要多添加三个服务器控件：隐藏字段，您选择的省市县数据将在客户端由程序分别写入三个隐藏字段�?
 ...
 * 3、在页面中添加jQuery语句，调用此插件，并对相关参数进行设�?如：
 * <script type="text/javascript">
 *   $(document).ready(function() {
 *       $("#ChinaArea").jChinaArea();
 *   });
 * </script>
 * 4、在ASP.NET中，您需要通过下面语句来调�?即设置参数aspnet的值为true.
 * <script type="text/javascript">
 *   $(document).ready(function() {
